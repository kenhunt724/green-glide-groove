      ...
      <section className="border-b border-border">
        <div className="mx-auto max-w-7xl px-5 py-20">
          ...
          <p className="mt-6 max-w-2xl text-lg text-muted-foreground">
            Every title here is served as the mastering engineer left it. Scrub the waveform, hear
            the room, and buy the file or the physical copy from the shelf that keeps it.
          </p>
        </div>
      </section>
      ...
      <section className="border-t border-border bg-surface">
        <div className="mx-auto max-w-7xl px-5 py-16">
          ...
          <p className="mt-3 max-w-2xl text-muted-foreground">
            Physical stock stays the property of the artist until it sells. The Society takes the
            floor space, the counter, and nothing else it hasn&apos;t earned.
          </p>
